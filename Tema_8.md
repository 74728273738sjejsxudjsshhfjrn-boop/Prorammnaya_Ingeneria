...
###Вывод: Данная программа создает класс 'Car' с атрибутами, после создаётся объект класса
...
###Вывод: Данная программа добавляет в программу из прошлого задания атрибуты и методы класса, заставляет машину “поехать"
...
###Вывод: Данная программа создает новый класс "ElectricCar" с методом "charge" и атрибутом емкость батареи
...
###Вывод: Данная программа реализует инкапсуляцию для класса
...
###Вывод: Данная программа реализует полиморфизм создав основной (общий) класс "Shape", а также еще два класса "Rectangle” и “Circle”
...
###Вывод: Данная программа создает класс и его объект
...
###Вывод: Данная программа создает атрибуты и методы для ранее созданного класса
...
###Вывод: Данная программа словарь, который в качестве ключей принимает данные числа, а в качестве значений количество этих чисел в имеющейся последовательности
...
###Вывод: Данная программа реализует инкапсуляцию
...
###Вывод: Данная программа реализует полиморфизм
