...
if value in numbers:
    ...
    if value % 2 == 0:
        ...
        print(f"Переменной нет в данном массиве и она равна {valuae}")
...
## 6. Напишите программу, в которой при помощи цикла for определяется есть ли переменная value в строке string и посмотрите, как работает оператор else для циклов.
...
<p align="center">
  <img src="images/14(1).png" width="600">
</p>

<p align="center">
  <img src="images/14(2).png" width="600">
</p>

<p align="center">
  <img src="images/14(3).png" width="600">
</p>
